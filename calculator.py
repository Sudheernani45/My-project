...
clear = tk.Button(buttons_frame, text="c", fg="black", width=32, height=3, bd=0, bg="#eee",cursor="hand2", command=lambda: button_clear()).grid(row=0, column=0,columnspan=3,padx=1, pady=1)
...
equals = tk.Button(buttons_frame, text="=", fg="black", width=10, height=3, bd=0, bg="#fff",cursor="hand2", command=lambda: button_click("=")).grid(row=4, column=3, padx=1, pady=1)
